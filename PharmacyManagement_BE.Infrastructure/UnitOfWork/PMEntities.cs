...
namespace PharmacyManagement_BE.Infrastructure.UnitOfWork
{
    public class PMEntities : IPMEntities
    {
        ...
        public IProductUnitService ProductUnitService { get;set; }
        ...
        public PMEntities(PharmacyManagementContext context, IProductService productService, IBranchService branchService, ICartService cartService,
            ICategoryService categoryService, ICommentService commentService, ICustomerService customerService, IDiseaseService diseaseService,
            IDiseaseSymptomService diseaseSymptomService, IIngredientService ingredientService, IOrderDetailsService orderDetailsService, IOrderService orderService,
            IPaymentMethodService paymentMethodService, IProductDiseaseService productDiseaseService, IProductImageService productImageService, 
            IProductIngredientService productIngredientService, IProductSupportService productSupportService, IProductUnitService productUnitService,
            IPromotionHistoryService promotionHistoryService, IPromotionProductService promotionProductService, IPromotionProgramService promotionProgramService,
            IPromotionService promotionService, IReceiverInformationService receiverInformationService, IShipmentDetailsService shipmentDetailsService, IShipmentService shipmentService,
            IStaffService staffService, ISupplierService supplierService, ISupportService supportService, ISymptomService symptomService,
            IUnitService unitService, IVoucherHistoryService voucherHistoryService, IVoucherService voucherService)
        {
